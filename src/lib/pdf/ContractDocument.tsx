    ...
    <Document title={`สัญญาเช่าห้องพัก ${room.room_number}`} language="th">
      <Page size="A4" style={styles.page}>
        ...
        <Text style={styles.paragraph}>
          ...
          {tenant.full_name}
          {tenant.id_card_or_passport ? ` เลขที่บัตรประชาชน/พาสปอร์ต ${tenant.id_card_or_passport}` : ''}{' '}
          ในฐานะ &quot;ผู้เช่า&quot; อีกฝ่ายหนึ่ง ทั้งสองฝ่ายตกลงทำสัญญาเช่าห้องพัก โดยมีข้อความดังต่อไปนี้
        </Text>
        ...
        <View style={styles.section}>
          ...
          <InfoRow label="จำนวนผู้พักอาศัยทั้งหมด" value={`${contract.occupant_count} คน (รวมผู้เช่า)`} />
        </View>
        ...
        <View style={styles.section}>
          ...
          <Bullet>
            เงินประกันจะคืนให้แก่ผู้เช่าเมื่อสิ้นสุดสัญญาเช่า และห้องพักอยู่ในสภาพเรียบร้อยไม่มีความเสียหาย
            หลังหักค่าใช้จ่ายค้างชำระ (ถ้ามี)
          </Bullet>
          <Bullet>
            ผู้เช่าต้องดูแลรักษาห้องพักและทรัพย์สินภายในห้องให้อยู่ในสภาพดี และแจ้งผู้ให้เช่าทันทีหากพบความเสียหาย
          </Bullet>
          <Bullet>
            ห้ามผู้เช่านำบุคคลอื่นเข้าพักอาศัยเกินจำนวนที่ระบุไว้ในข้อ 4 โดยไม่ได้รับความเห็นชอบจากผู้ให้เช่า
          </Bullet>
          <Bullet>คู่สัญญาทั้งสองฝ่ายได้อ่านและเข้าใจข้อความในสัญญานี้โดยตลอดแล้ว จึงลงลายมือชื่อไว้เป็นหลักฐาน</Bullet>
        </View>
